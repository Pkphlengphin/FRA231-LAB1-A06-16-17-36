###########################################################################
## Makefile generated for component 'encode2'. 
## 
## Makefile     : encode2.mk
## Generated on : Thu Oct 31 23:39:18 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/encode2.elf
...
COMPILER_COMMAND_FILE     = encode2_comp.rsp
CMD_FILE                  = encode2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/encode2.elf
...
DEFINES_STANDARD = -DMODEL=encode2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/encode2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/encode2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/encode2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/encode2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/encode2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encode2.o : $(START_DIR)/encode2_ert_rtw/encode2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/encode2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
